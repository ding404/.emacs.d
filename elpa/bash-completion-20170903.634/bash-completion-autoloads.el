...
;;;***

;;;### (autoloads nil "sz-testutils" "sz-testutils.el" (0 0 0 0))
;;; Generated autoloads from sz-testutils.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "sz-testutils" '("sz-testutils-")))
